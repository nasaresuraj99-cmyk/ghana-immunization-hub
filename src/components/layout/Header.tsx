...
import { Menu, LogOut, Home, UserPlus, List, AlertTriangle, LayoutDashboard, BarChart3, Settings, X, Wifi, WifiOff, Calendar, Mail, RefreshCw, Users, Archive, Activity, QrCode, CloudUpload, AlertCircle, BookOpen, History, Package } from "lucide-react";
...
export const getNavItems = (userRole?: AppRole) => {
  ...
  const items = [
    ...
    { id: 'outreach-history', label: 'Outreach', icon: History },
