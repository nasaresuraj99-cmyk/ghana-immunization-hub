  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        outline: "border-2 border-input bg-background hover:bg-muted hover:border-primary/30 active:bg-muted/80",
        secondary: "bg-secondary text-secondary-foreground shadow-sm hover:shadow-md hover:bg-secondary/80 active:shadow-none",
        ghost: "hover:bg-muted active:bg-muted/80",
        link: "text-primary underline-offset-4 hover:underline",
        // Material Design inspired variants
        elevated: "bg-card text-card-foreground shadow-elevation-2 hover:shadow-elevation-3 active:shadow-elevation-1",
        tonal: "bg-primary/10 text-primary hover:bg-primary/20 active:bg-primary/30",
        success: "bg-success text-success-foreground shadow-md hover:shadow-lg hover:bg-success/90 active:shadow-sm",
      },
      size: {
